-- ข้อมูลตั้งต้นสำหรับร้าน: categories, products, toppings และ stock (ไม่ใช้เป็นยอดขายจริง)
-- ===================================================================
...
-- ระบบจริงไม่เก็บออเดอร์สาธิต: ลบข้อมูลชุดเก่าหลัง seed เมนูและสต๊อกเสร็จ
